...
- **Latest run**:
  [`2026-08-03_document-model-canon-adoption`](runs/2026-08-03_document-model-canon-adoption/07_CLOSEOUT.md)
  — local adoption completed; publication awaits human decision.
...
- **Next action**: obtain the human decision for publication toward `main`;
  do not push, merge, tag, or certify Pi before that decision.
