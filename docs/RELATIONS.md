...
| `architecture-source` | `governance-core`, `contract-tooling` | dependency mapping, refactoring impact analysis, sensitive zone visualization, agentic coding framing | `docs/ARCHITECTURE.md`, `docs/RELATIONS.md`, `docs/adr/*.md`, `tools/vbb-architecture.py`, `tests/test_vbb_architecture.py` |
