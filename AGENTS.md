...
9. **Quality conventions**: Agents must follow `docs/CONVENTIONS.md` by default for readability, modularity, and coherence. Any canon change requires a documented proposal and human validation. See `docs/templates/CANON_CHANGE_PROPOSAL.md.template`.
